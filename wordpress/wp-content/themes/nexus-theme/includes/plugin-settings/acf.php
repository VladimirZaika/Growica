		...
		acf_register_block( [
			...
			'example'  => [
	            'attributes' => [
	                'mode' => 'preview',
	                'data' => [
	                	'preview_image_help' => get_stylesheet_directory_uri().'/src/images/block-hero.png',
					]
				]
			],
		] );
		...
		acf_register_block( [
			...
			'example'  => [
	            'attributes' => [
	                'mode' => 'preview',
	                'data' => [
	                	'preview_image_help' => get_stylesheet_directory_uri().'/src/images/block-cta.png',
					]
				]
			],
		] );
...
/**
 * Define nexus category module Gutenberg
 */
function custom_block_category( $categories, $post ) {
	$custom_block = [
	  'slug' => 'base-template-blocks',
	  'title' => __( 'nexus Modules', 'custom-blocks' ),
	];
 ...
 */
function nexus_enqueue_custom_blocks_styles() {
...
add_action( 'enqueue_block_assets', 'nexus_enqueue_custom_blocks_styles', 100 );
