(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    var stickyHeaderNexus = /*#__PURE__*/function () {
      function stickyHeaderNexus(headerSelector) {
        _classCallCheck(this, stickyHeaderNexus);
      ...
      return _createClass(stickyHeaderNexus, [{
        key: "onScroll",
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var bodyLockNexusStatus = true;
    var bodyLockToggleNexus = function bodyLockToggleNexus() {
    ...
    var bodyUnlockNexus = function bodyUnlockNexus() {
      var delay = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 500;
    ...
    var bodyLockNexus = function bodyLockNexus() {
      var delay = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 500;
      var body = document.querySelector("body");
      var stickyHeader = document.querySelector("header._header-scroll");
      if (bodyLockNexusStatus) {
