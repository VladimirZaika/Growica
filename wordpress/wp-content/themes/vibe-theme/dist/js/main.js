(function () {
  ...
  document.addEventListener('DOMContentLoaded', function () {
    var stickyHeaderVibe = /*#__PURE__*/function () {
      function stickyHeaderVibe(headerSelector) {
        _classCallCheck(this, stickyHeaderVibe);
      ...
      return _createClass(stickyHeaderVibe, [{
        key: "onScroll",
  ...
  document.addEventListener('DOMContentLoaded', function () {
    ...
    var bodyLockVibeStatus = true;
    var bodyLockVibeToggleVibe = function bodyLockVibeToggleVibe() {
    ...
    var bodyUnlockVibe = function bodyUnlockVibe() {
      var delay = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 500;
    ...
    var bodyLockVibe = function bodyLockVibe() {
      var delay = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 500;
      var body = document.querySelector("body");
      var stickyHeader = document.querySelector("header._header-scroll");
      if (bodyLockVibeStatus) {
