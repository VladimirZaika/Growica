...
add_action(
	'after_setup_theme',
	function () {
		load_theme_textdomain( 'nexus', get_theme_file_uri( 'languages' ) );
...
add_action(
	...
	function () {
		if ( ! isset( $GLOBALS['content_width'] ) ) {
			$GLOBALS['content_width'] = apply_filters( 'nexus_content_width', 1236 );
		}
	},
	0
);
...
function nexus_customize_register($wp_customize) {
    ...
    $wp_customize->add_control(new WP_Customize_Color_Control($wp_customize, 'optional_color_1', [
        'label'    => __('Optional Color #1', 'nexus'),
        'section'  => 'colors',
